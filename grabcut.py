# based on https://github.com/symao/InteractiveImageSegmentation/

# add functionality to read mask from file
# add + / - keys to increment size of pen
# python grabcut.py /Datasets/handpalm/frames/ /Datasets/handpalm/frames/masks
# python grabcut.py /Datasets/11k-hands/Hands_palms_small/ /Datasets/11k-hands/Hands_palms_small_masks/
